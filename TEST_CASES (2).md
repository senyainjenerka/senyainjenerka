# Тест-кейсы: поиск, фильтры и профиль специалиста (клиентское веб-приложение)
...
**Автор:** Ксения Середа | **Всего кейсов:** 74 | **Тип:** Functional

## Оглавление

1. [Поиск специалиста](#поиск-специалиста) — 15 кейсов
2. [Фильтры результатов поиска](#фильтры-результатов-поиска) — 18 кейсов
3. [Список и карточка специалиста, сортировка](#список-и-карточка-специалиста-сортировка) — 23 кейсов
4. [Полный профиль специалиста и календарь](#полный-профиль-специалиста-и-календарь) — 10 кейсов
5. [Дополнительные негативные сценарии: поиск](#дополнительные-негативные-сценарии-поиск) — 8 кейсов
...
### TC-008. Check that the user informed if Платформа is not officially launched in a specified state
**Приоритет:** Незначительный | **Тип сценария:** Позитивный
